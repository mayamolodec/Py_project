...
Чтобы программа заработала необходимо в консоли ввести: -I (показатель цвета в кавычках, например 'J-K') -С (значение показателя цвета) -Z (металличность от -4 до 1) -G (log(g) от 0 до 6)
